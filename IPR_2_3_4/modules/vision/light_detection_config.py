...
NUMBER_OF_RED_CALIBRATION_POINTS = len(RED_CALIBRATION_TABLE)
NUMBER_OF_YELLOW_CALIBRATION_POINTS = len(YELLOW_CALIBRATION_TABLE)
NUMBER_OF_GREEN_CALIBRATION_POINTS = len(GREEN_CALIBRATION_TABLE)
